...
- System Design
  ...
  - Architectural Decision
    ...
    Serverless Architecture আমরা ইউজ করবো তখন, যখন ক্লায়েন্ট বলবে আমি MVP চাইছি, কিন্তু খুব সম্ভাবনা আছে এই অ্যাপ্লিকেশন খুব তাড়াতাড়ি গ্রো করার। যদি গ্রো করে ফেলে খুব তাড়াতাড়ি আমি চাই না কোনো ধরণের কোনো সমস্যা ইউজার ফেইস করুক বা ইউজার কোনো অভিযোগ আমাদের জানাক। কারণ এটা হাইলি স্কেলেবল। কিন্তু ভেন্ডর লক হয়ে যাবার সম্ভবনা আছে। Microsoft Azure থেকে google cloud এ শিফট করা যাচ্ছে না।
...
- Distribution
  ...
  - Cloud Engineering - আমাদের একটা ক্লাউড দরকার যেখানে আমরা আমাদের অ্যাপ্লিকেশনকে ডেপ্লয় করতে পারি। এখানে অসংখ্য ডিজাইন ডিসিশন চলে আসে। যেমন
    ...
    - DynamoDB
    - Route 53
    - CloudFront (CDN => Content Delivery Service) (ক্যাশিং এ ব্যবহার হয়)
    ...
    - Step Functions
    - Cloud Watch
    - Cloud Formation, Terraform, CDK(Infratucture as a code)
      এগুলো ব্যবহার করার মাধ্যমে আমরা Non functionalities requirements প্রোভাইড করতে পারবো।
- Maintenance

## Decision

উপরে যা শিখলাম তার উপর ভিত্তি করে এবার আমাদের অ্যাপ্লিকেশনের(PS Caffe) ডিসিশন নিয়ে নিই। যেহেতু MVP হবে এবং বলা আছে কোনো হাই এভেইলেবিলিটি বা স্কেলেবিলিটির দরকার নেই তাই আমরা ক্লাউড ইঞ্জিনিয়ারিং পার্ট বাদ দিতে পারি। জাস্ট ৪/৮ জিবি র‍্যামের সার্ভার হলেই চলবে। ইনিশিয়ালি ডেভঅপ্সেরও প্রয়োজন নাই কারণ আমাদের দ্রুত একটা ওয়ার্কেবল প্রোটোটাইপ লাগবে। পরে অবশ্যই দরকার হবে।
...
- ব্যাকএন্ডের জন্য আমাদের দুইটা প্রশ্ন করতে হবে নিজেদের। প্রথম প্রশ্ন আমাদের অ্যাপ্লিকেশনে হেভি কম্পিউটিং করতে হবে কিনা (ভিডিও প্রসেসিং / ইমেজ প্রসেসিং, পিডিএফ জেনারেশন, অনেক ক্যাল্কুলেশন আছে)? যদি না হয় তাহলে .Net, Java Spring boot, Go lang বাদ। দ্বিতীয় প্রশ্ন হলো আমার অ্যাপ্লিকেশন data driven, MVC, multipage কিনা? যদি MVC হয় তাহলে NodeJS বাদ। আমরা সিলেক্ট করবো Django, Laravel বা Ruby on rails. যদি MVC না হয়, ডেটা ড্রাইভেন হয় এবং রিয়েল টাইম হয় তাহলে চোখ বন্ধ করে NodeJS. আমাদের অ্যাপ্লিকেশন ডেটা ড্রাইভেন তাই আমাদের অ্যাপ্লিকেশনের জন্য সিলেক্ট করবো NodeJS. nodejs এ আমরা সেকেন্ড হাজার হাজার রিকোয়েস্ট একসেপ্ট করতে পারবো কারণ জাভাস্ক্রিপ্ট সিঙ্গেল থ্রেড ইভেন্ট ড্রিভেন আর্কিটেকচার ফলো করে, সে কোনো রিকোয়েস্ট ব্লক করবে না। pythod, ruby, PHP এর ক্ষেত্রে কোনো রিকোয়েস্ট প্রসেস করতে যদি ৩০০ মিলি সেকেন্ড লাগে এই সময়ে এরা আর কোনো রিকোয়েস্ট সার্ভ করবে না এই সময়টা ব্লক হয়ে থাকবে । কিন্তু এই রিকোয়েস্ট প্রসেস করার সময় অন্য রিকোয়েস্ট নিবে এবং queue আকারে প্রসেস করবে। nodejs 40K রিকোস্ট প্রযন্ত হ্যান্ডেল করতে পারে সেকেন্ডে সার্ভারের ক্যাপাসিটি অনুযায়ী। nodejs api গেটওয়ে হিসেবে বেস্ট। এক্ষেত্রে নোড জেএসের ফ্রেমওয়ার্ক হিসেবে Hapi, Express বা Fastify ব্যবহার করতে পারি।
