...
এবার ধরে নিলাম আমাদের অ্যাপ্লিকেশনে ডাটাবেইজ আছে। মডেলের সাথে ডাটাবেইজের কমিউকেশন করার জন্য কয়েকটা সুন্দর ORM (Object Relational Mapping) আছে যাদের নাম [Mongoose](https://mongoosejs.com/), [Sequelize](https://sequelize.org/), [TypeORM](https://typeorm.io/), [Prisma](https://www.prisma.io/). যদি আমরা [MongoDB](https://www.mongodb.com/) নিয়ে কাজ করতে চাই তাহলে আমরা [Mongoose](https://mongoosejs.com/) ইউজ করবো। আমরা [Mongoose](https://mongoosejs.com/) ইনস্টল করে ফেলি।
